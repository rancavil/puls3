...
from .actions import export_json
...
class EnlaceInline(admin.StackedInline):
	model = Enlace
	extra = 1 # Es el numero de enlaces vacios se crean para cada categoria
